...
namespace CouponsForGiving.Data
{
    ...
    public partial class C4GEntities : DbContext
    {
        ...
        public virtual ObjectResult<DealInstance> DealInstance_ListForGlobalMarketplace()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DealInstance>("DealInstance_ListForGlobalMarketplace");
        }
    
        public virtual ObjectResult<DealInstance> DealInstance_ListForGlobalMarketplace(MergeOption mergeOption)
        {
        ...
        public virtual ObjectResult<Campaign> Campaign_ListByDeal(Nullable<int> dealInstanceID)
        {
            var dealInstanceIDParameter = dealInstanceID.HasValue ?
                new ObjectParameter("DealInstanceID", dealInstanceID) :
                new ObjectParameter("DealInstanceID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Campaign>("Campaign_ListByDeal", dealInstanceIDParameter);
        }
    
        public virtual ObjectResult<Campaign> Campaign_ListByDeal(Nullable<int> dealInstanceID, MergeOption mergeOption)
        {
            var dealInstanceIDParameter = dealInstanceID.HasValue ?
                new ObjectParameter("DealInstanceID", dealInstanceID) :
                new ObjectParameter("DealInstanceID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Campaign>("Campaign_ListByDeal", mergeOption, dealInstanceIDParameter);
        }
    
        public virtual ObjectResult<Campaign> Campaign_ListByCity(string cityName, string provinceName)
        {
            var cityNameParameter = cityName != null ?
                new ObjectParameter("CityName", cityName) :
                new ObjectParameter("CityName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Campaign>("Campaign_ListByCity", cityNameParameter, provinceNameParameter);
        }
    
        public virtual ObjectResult<Campaign> Campaign_ListByCity(string cityName, string provinceName, MergeOption mergeOption)
        {
            var cityNameParameter = cityName != null ?
                new ObjectParameter("CityName", cityName) :
                new ObjectParameter("CityName", typeof(string));
        ...
        public virtual ObjectResult<PurchaseOrder_ListByNPO_Result> PurchaseOrder_ListByNPO(string username)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("Username", username) :
                new ObjectParameter("Username", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PurchaseOrder_ListByNPO_Result>("PurchaseOrder_ListByNPO", usernameParameter);
        }
    
        public virtual ObjectResult<DealInstance> DealInstance_ListAllByMerchant(string username)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("Username", username) :
                new ObjectParameter("Username", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DealInstance>("DealInstance_ListAllByMerchant", usernameParameter);
        }
    
        public virtual ObjectResult<DealInstance> DealInstance_ListAllByMerchant(string username, MergeOption mergeOption)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("Username", username) :
                new ObjectParameter("Username", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DealInstance>("DealInstance_ListAllByMerchant", mergeOption, usernameParameter);
        }
