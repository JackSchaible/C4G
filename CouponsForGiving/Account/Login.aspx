...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="Main_Content">
    ...
    <div class="half">
        <section id="loginForm">
            ...
            <asp:Login runat="server" ViewStateMode="Disabled" RenderOuterTable="false">
                <LayoutTemplate>
                    ...
                    <fieldset>
                        ...
                        <div class="FormRow">
                            <asp:CheckBox runat="server" ID="RememberMe" class="" />
            ...
            <p><asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled">Register</asp:HyperLink> if you don't have an account.</p>
        </section>
    </div>
    <div class="half dark">
