                ...
                <section id="MainContent">                  
                    <div id="content" class="no-sidebar">
                        <div class="three-quarters"><!-- Removed the div #text and also the #NPO-->
                            ...
                            <h3 class="merchant-address"><%: npo.Name %></h3><!-- This should be the Charity Name -->
                            <h2>About the Campaign</h2>
                            <p><img alt="Our Logo" class="merchant_logo" src="../../<%: npo.Logo %>" /><%: campaign.CampaignDescription %></p> <!-- Campaing Description -->
