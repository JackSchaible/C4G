    ...
    <footer>
        <div id="Div1">
		    ...
		    <ul class="footer-nav">
			    ...
			    <li><a id="A2" runat="server" href="~/AboutUs.aspx?c=WhoWeAre">Who We Are</a></li>
			    <li><a id="A3" runat="server" href="~/AboutUs.aspx?c=OurTeam">Our Team</a></li>
			    <li><a id="A4" runat="server" href="~/InTheCommunity.aspx">In The Community</a></li>
			    <li><a id="A5" runat="server" href="~/Default/Home.aspx">My Coupons</a></li>
			    <li><a id="A6" runat="server" href="~/NPO/Home.aspx">My Campaigns</a></li>
			    <li><a id="A7" runat="server" href="~/Merchant/Home.aspx">For Merchants</a></li>
			    <li><a id="A8" runat="server" href="~/Blog.aspx">Blog</a></li>
		    </ul>
            <ul>
                <li><a id="A9" runat="server" href="~/Content/Terms/PrivacyPolicy.pdf">Privacy Policy</a></li>
                <li><a id="A10" runat="server" href="~/Content/Terms/TermsOfUse.pdf">Terms of Use</a></li>
                <li><a id="A11" runat="server" href="~/FAQ.aspx">FAQs</a></li>
                <li><a id="A12" runat="server" href="~/Careers.aspx">Careers</a></li>
            </ul>
